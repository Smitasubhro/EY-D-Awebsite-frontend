...
const AddUseCase = () => {
    ...
    const [formData, setFormData] = useState({clientName:"",techName:"",region:"",industry:"",
        ...
        business:"",effort:"",year:"",startdate:"",enddate:"",title:"",usecaseid:uniqueid
    });
    ...
    const onSubmitHandler = async(e) => {
        ...
        setIsBtnLoading(true)
          ...
          const response = await fetch(
            'http://dawebsitebackend-cbbsfecegrejhvbx.eastus-01.azurewebsites.net/api/uploadImage',
            {
              method: "POST",
              body: data,
            }
          ...
          const addresponse = await fetch(
            'http://dawebsitebackend-cbbsfecegrejhvbx.eastus-01.azurewebsites.net/api/addUseCase',
            {
              method: "POST",
              headers: {
          ...
          console.log("use case added ",addresult)
          if(addresult.status==="success")
          {
            const Toast = Swal.mixin({
              ...
              Toast.fire({
                icon: "success",
                title: "Usecase added successfully"
              }).then(()=>{
                navigate("/usecases");
              })
          }
  ...
  return (
    <div className='addusecase-wrapper'>
        <div className='addusecase-wrapper-1'>
        ...
        <div className='addusecase-wrapper-2'>
            <div className='addusecase-form'>
                <form className='addusecase-main-form' onSubmit={ onSubmitHandler }>
                    <div className='form-field-text'>
                        <label for='usecaseid'>Usecase Id</label>
                        <input type="text" id='usecaseid' name='usecaseid'
                        value={formData.usecaseid} readonly disabled={true}/>
                    </div>
                    <div className='form-field-text'>
                    ...
                    <div className='form-btn'>
                        <div className='addusecase-form-btn'>
